...
9. [] ships should not pass through the bottom of their side. parts that touch the bottom should crumble instead of passing through to the other side. here's an example of how my sank ship breaks through the bottom to the other side:
