        ...
        this.container.innerHTML = `
            ...
            <div class="hud-bottom-bar">
                <div class="hud-controls-panel ui-interactive" style="grid-template-columns: repeat(9, 1fr);">
                    ...
                    <div class="sw-mount"><div class="sw-label">CAM</div><div id="led-cam-reset" class="sw-led"></div><button id="hud-btn-cam-reset" class="sw-push" title="Reset Camera" style="font-size: 0.8rem;">VIEW</button></div>
                    <div class="sw-mount"><div class="sw-label">FPS</div><div class="sw-led on-green"></div><button id="hud-btn-fps" class="sw-push" title="Cycle FPS Cap" style="font-size: 0.7rem;">${Config.visual.fpsCap || 60}<br>FPS</button></div>
                    <div class="sw-mount"><div class="sw-label">SPEED</div><div class="sw-led on-green"></div><button id="hud-btn-speed" class="sw-push" title="Cycle Speed" style="font-size: 0.8rem;">${Config.timing.gameSpeedMultiplier}X</button></div>
